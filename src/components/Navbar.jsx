...
import rlelogo from '../../public/logo-rle.png'
  ...
  return (
    <div className="p-1 md:p-4 flex items-center justify-between h-10 w-full">
      <div className="flex flex-row items-center gap-2">
        <img src={rlelogo} alt="" height={50} width={200} className="dark:hidden pt-5" />
        {/* <img
          src={gif}
          alt=""
          height={20}
        ...
        {/* <span className="text-2xl font-[1000] text-center dark:text-white">
          RoyalLuxury
          <span className="font-extrabold text-sm"> LLC</span>
        </span> */}
      </div>
